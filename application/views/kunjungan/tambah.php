...
<div class="app-content-header pt-3">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="mb-0"><?= $title ?? 'Tambah Data Kunjungan' ?></h3>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card card-primary">
                    ...
                    <?= form_open('kunjungan/tambah_aksi'); ?>
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="keluhan" name="keluhan" placeholder="Masukkan Keluhan" value="<?= set_value('keluhan'); ?>">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_kunjungan" name="tanggal_kunjungan" value="<?= set_value('tanggal_kunjungan'); ?>">
