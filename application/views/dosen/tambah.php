...
<div class="app-content-header pt-3">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="mb-0"><?= $title ?? 'Tambah Data Dosen' ?></h3>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_dsn" name="nama_dsn" placeholder="Masukkan Nama Dosen" value="<?= set_value('nama_dsn'); ?>">
                            <?= form_error('nama_dsn', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <div class="form-group mb-3">
                            <label for="nidn">NIDN</label>
                            <input type="text" class="form-control" id="nidn" name="nidn" placeholder="Masukkan NIDN (contoh: 0405068801)" value="<?= set_value('nidn'); ?>">
